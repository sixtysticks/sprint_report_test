...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { from: @sprint.from, name_sprint: @sprint.name_sprint, to: @sprint.to, total_days: @sprint.total_days }
    end
  ...
  test "should update sprint" do
    patch :update, id: @sprint, sprint: { from: @sprint.from, name_sprint: @sprint.name_sprint, to: @sprint.to, total_days: @sprint.total_days }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
